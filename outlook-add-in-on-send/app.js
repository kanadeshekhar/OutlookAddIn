 ...
 */
    ...
    // Add a CC to the email.  In this example, CC shekhar.kanade@regoconsulting.com
    // <param name="event">MessageSend event passed from calling function</param>
    function addCCOnSend(event) {
        mailboxItem.cc.setAsync(['shekhar.kanade@regoconsulting.com'], { asyncContext: event });        
    }
